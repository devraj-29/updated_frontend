        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          >
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
              <path
                d="M12 2L3 7v5.5c0 5.6 3.8 10.7 9 12 5.2-1.3 9-6.4 9-12V7L12 2z"
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: 12,
                border: `1.5px solid ${
                  focused === "email" ? C.accent : C.border
                }`,
                ...
                color: C.text,
                boxShadow:
                  focused === "email" ? `0 0 0 3px ${C.accentSoft}` : "none",
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: 12,
                border: `1.5px solid ${
                  focused === "pass" ? C.accent : C.border
                }`,
                ...
                color: C.text,
                boxShadow:
                  focused === "pass" ? `0 0 0 3px ${C.accentSoft}` : "none",
                transition: "all 0.2s ease",
              }}
            />
          </div>
